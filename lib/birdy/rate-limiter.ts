 ...
 * Works correctly for Railway's single-container deployment.
 * For multi-instance scale-out: swap this for Upstash Redis.
 */
...
export function getRateLimitIdentifier(req: Request): string {
  // Use x-forwarded-for (Railway proxy) or fallback
