...
<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
  ...
  <div style="padding:24px;background:#fff">
    <table style="width:100%;border-collapse:collapse;margin-bottom:20px">
      <tr>
        <td style="padding:9px 12px;background:#f5f4f0;border-radius:4px"><strong>Name:</strong> ${a.fullName || '—'}</td>
        <td style="padding:9px 12px;background:#f5f4f0;border-radius:4px"><strong>Email:</strong> ${a.email || '—'}</td>
      </tr>
      <tr>
      ...
      <tr>
        <td style="padding:9px 12px;background:#f5f4f0;border-radius:4px"><strong>Role:</strong> ${a.roleTitle || 'General'}</td>
        <td style="padding:9px 12px;background:#f5f4f0;border-radius:4px"><strong>Work Auth:</strong> ${a.workAuthorization || '—'}</td>
      </tr>
      <tr>
    ...
    ${a.q3 ? `<div style="padding:12px;background:#f5f4f0;border-radius:5px;margin-bottom:8px">
      <p style="color:#c0152a;font-size:10px;text-transform:uppercase;letter-spacing:1px;margin:0 0 5px;font-weight:700">Q3 — Competing Priorities</p>
      <p style="margin:0;font-size:13px;color:#0a1628">${a.q3}</p>
    </div>` : ''}
  ...
  <div style="background:#0a1628;padding:14px;text-align:center">
    <p style="color:#4b5568;font-size:11px;margin:0">
      PeopleBook · Ray Land Inc. · Stable Engineering // Design Innovation // Perpetual Service
    </p>
  </div>
</div>`,
    })
...
<div style="font-family:Arial,sans-serif;max-width:520px;margin:0 auto">
  ...
  <div style="padding:32px;text-align:center;background:#fff">
    ...
    <div style="background:#f5f4f0;border-radius:8px;padding:14px 20px;text-align:left;margin:16px 0">
      <p style="margin:0 0 6px;font-size:13px;color:#0a1628">
        <strong>Role Applied For:</strong> ${a.roleTitle || 'General Application'}
      </p>
      <p style="margin:0;font-size:13px;color:#0a1628">
        <strong>Submitted:</strong> ${new Date().toLocaleDateString('en-US', { weekday:'long', month:'long', day:'numeric', year:'numeric' })}
      </p>
    </div>
    <p style="font-size:12px;color:#9a9890">
      Questions? Contact us at
      <a href="mailto:anthony@runbusiness.com" style="color:#c0152a">anthony@runbusiness.com</a>
    </p>
