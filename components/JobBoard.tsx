...
export default function JobBoard({ roles }: { roles: any[] }) {
  ...
  return (
    <section id="roles" style={{ maxWidth: 1280, margin: '0 auto', padding: '56px 24px' }}>
      ...
      {filtered.length === 0 ? (
        <div style={{ textAlign: 'center', padding: '80px 0', fontFamily: "'Rajdhani',sans-serif", fontSize: 16, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.15em', color: '#8299c0' }}>
        ...
        <div style={{
          ...
          {filtered.map(r => (
            <div key={r.id} style={{ background: '#f5f4f0', display: 'flex' }}>
